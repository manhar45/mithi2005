...
var client = new Client({
   apiKey: 'c3ncWF09Dh13njqq',
   apiSecret: 'tgZroUvHP4KFQGAIxUOAOqDnMXpw2I2n'
});
...
_mode: 'markdown',disable_webpage_preview:true}).catch((err) => sendError(err, ctx))
